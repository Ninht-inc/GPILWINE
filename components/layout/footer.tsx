...
export function Footer() {
  ...
  const socials = [
    { name: 'facebook', url: s.social_facebook },
    { name: 'instagram', url: s.social_instagram },
    { name: 'twitter', url: s.social_twitter },
    { name: 'youtube', url: s.social_youtube },
    { name: 'whatsapp', url: s.whatsapp_number ? `https://wa.me/${s.whatsapp_number.replace(/[^\d]/g, '')}` : '' },
  ].filter((x) => x.url)
